...
const commissionTiers = [
  ...
  { tier: 'Growth', rate: '8%', volume: '₹1L – ₹10L/month recovered', description: 'For scaling e-commerce businesses', featured: true },
  { tier: 'Enterprise', rate: 'Custom', volume: '₹10L+/month recovered', description: 'Tailored for high-volume shippers' },
];

const billingSteps = [
  { step: '1', title: 'Pay ₹4,999 Setup Fee', description: 'One-time onboarding to configure your account', icon: IndianRupee, color: 'text-primary', bg: 'bg-primary/10' },
  { step: '2', title: 'Upload Courier Bills', description: 'We audit every shipment against your rate cards', icon: Upload, color: 'text-secondary', bg: 'bg-secondary/10' },
  { step: '3', title: 'We Find Overcharges', description: 'You pay % only on the recovered amount', icon: Search, color: 'text-success', bg: 'bg-success/10' },
];
    ...
    <section id="pricing" className="relative bg-muted/30 py-20 md:py-28 overflow-hidden">
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mb-14 text-center">
          ...
          <h2 className="mb-3 text-3xl font-bold text-foreground md:text-4xl">Pay Nothing Until We Recover Your Money</h2>
          <p className="mx-auto max-w-2xl text-muted-foreground md:text-lg">One small setup fee. Zero subscription. We earn only when you earn.</p>
        </div>
        ...
        <div className="mx-auto mt-16 max-w-4xl">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            {billingSteps.map((step, i) => (
              <div key={step.step} className="relative flex flex-col items-center text-center rounded-2xl border border-border bg-card p-6 shadow-card">
                ...
                <div className="mb-1 text-xs font-bold uppercase tracking-wider text-muted-foreground">Step {step.step}</div>
