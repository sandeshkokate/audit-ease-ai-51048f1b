        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          <div className="text-center lg:text-left">
            ...
            <p className="mx-auto mb-10 max-w-xl text-base sm:text-lg leading-relaxed text-muted-foreground lg:mx-0 animate-fade-in-up" style={{ animationDelay: '200ms', opacity: 0 }}>
              Billing discrepancies in shipping invoices can cost your business money. AuditEase helps D2C brands, e-commerce sellers, banks, NBFCs, and enterprises identify potential overcharges and recover what may be owed to you.
            </p>
